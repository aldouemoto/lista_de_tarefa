...
//let todos = ['abrir os olhos','escovar os dentes', 'tomar café da manhã','meditar','programar','ir ao encontro dos Hikers'];
...
//* Get description and create a new list
...
function removeItem(){
	...
	if(currentListId === 'todo-list') {
		...
		completed.splice(completed.indxOf(text), 1);
